...
namespace GeneralToolkitLib.WindowsApi
{
    ...
    {
        public static string GetUniqueSecurityIdForCurrentUser()
        {
            IntPtr logonToken = LogonUser();
            WindowsIdentity windowsIdentity = new WindowsIdentity(logonToken);

            return windowsIdentity.Name + windowsIdentity.User.Value;
        }

        public static WindowsIdentity GetWindowsIdentityForCurrentUser()
        {
            IntPtr logonToken = LogonUser();
            WindowsIdentity windowsIdentity = new WindowsIdentity(logonToken);
